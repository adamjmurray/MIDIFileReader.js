class MIDIFileReader
  ...
  _readMetaEvent: ->
    ...
    @events.push {type: "meta:#{type.toString(16)}", data: data}
    return
  ...
  _readSysExEvent: (type) ->
    ...
    @events.push {type: "sysex:#{type.toString(16)}", data: data}
    return
  ...
  _readChannelEvent: (typeMask, channel) ->
    ...
    @events.push {type: "channel:#{typeMask.toString(16)}", channel: channel, param1: param1, param2: param2}
    return
